...
const COMMENTARY = {
  ...
  "KOSPI": {
    ...
    themes: "**Defence/Electrical** \u2014 LS Electric (010120, #1, MS 88.6, +7.3% EPS CONFIRMED), Hyosung Heavy (298040, #4, +11.1% EPS CONFIRMED), LIG Nex1 (079550, #5, Existing Leader), Hyundai E\u0026C (000720, #3, Existing Leader). Double confirmation in the defence cluster.\n**Samsung Electro-Mechanics** (009150, #5, +15.8% RS, +12.8% EPS CONFIRMED) \u2014 first confirmed tech leader in KOSPI.\n**Mirae Asset** (006800, #2, +52% EPS CONFIRMED) \u2014 sole financial anchor.\n**Doosan Enerbility** (034020, Accelerating +84.9) \u2014 nuclear play worth watching.",
  ...
  "HSI": {
    ...
    themes: "**PetroChina** (857, #1, CONFIRMED) \u2014 top-ranked name. Energy still leads on rank.\n**WuXi AppTec** (2359, #4, New Leader CONFIRMED) \u2014 pharma/CDMO. Health Care overtook Energy on 1M RS.\n**Geely** (175, #5, +48.1% RS, New Leader UNCONFIRMED) \u2014 most extreme momentum globally. EV adoption thesis on $100+ oil.\n**AIA** (1299, #8, New Leader) \u2014 first insurance name in HSI leadership.\n**China Mobile** (941, Emerging +94.6) \u2014 highest acceleration in the index.\n**EV/Logistics Emerging** \u2014 BYD (Emerging), Hansoh Pharma (Emerging +95.9). Broadening beyond energy.",
  ...
  "STI": {
    ...
    themes: "**ST Engineering** (#1, MS 83, +4.7% EPS CONFIRMED) \u2014 top-ranked name. Defence/aerospace benefiting from global spending.\n**Keppel** (#2, MS 75.9, Existing Leader CONFIRMED) \u2014 energy/infrastructure conglomerate. Now confirmed.\n**Singapore Banks** \u2014 DBS (Emerging +100 acceleration), OCBC (Emerging). Both generating early signals but not yet leaders.\n**SGX** (#3, +11.9% RS) \u2014 exchange operator benefiting from elevated trading volumes.",
