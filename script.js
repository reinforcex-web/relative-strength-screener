...
const COMMENTARY = {
  "R1000": {
    ...
    daily: "**27 Mar session: S\u0026P 500 -1.67% to 6,369, Dow -1.73% (into correction), Nasdaq -2.15%.** Fifth straight weekly decline. WTI crossed $100 intraday for the first time since July 2022 before settling at $99.64 (+5.46%); Brent closed at $112.57 (+4.22%). VIX above 31. Trump extended the Iran strike deadline to April 6 but markets found no comfort \u2014 Iranian FM rejected all negotiations and the Hormuz yuan-toll mechanism continues to disrupt ~17.8M bpd.\n**Energy outperformed sharply.** Exxon +3.5% while the rest of the market sold off \u2014 the only sector in the green. This is directly consistent with our screener\u2019s Energy dominance: +21.5% avg 1M RS, 100% trend pass. APA (#51) and FTI (#56) both New Leaders CONFIRMED and would have caught the crude surge.\n**Tech/growth hammered again.** NVDA -2.2%, MSFT -2.5%, GOOGL -2.5%. META extended its post-ruling decline (-12% since Wednesday on the social media addiction verdict + layoffs). The broad tech selloff is consistent with IT\u2019s poor trend pass (25%) despite deep leadership \u2014 only the strongest names (CIEN, WDC, LITE, SNDK) are holding through.\n**Financials under pressure.** JPM -3%, Visa -3.3%. Treasury 10Y hit 4.41% (8-month high) as stagflation fears mount \u2014 OECD raised 2026 US inflation forecast to 4.2%. This undercuts the Financials near-flat RS (-0.2% 1M) and explains why the sector\u2019s Accelerating signals (MS, JPM, SCHW) haven\u2019t broken through to leader status.\n**Macro backdrop darkening.** Moody\u2019s recession model at 49% probability (pre-oil spike). Partial government shutdown continues \u2014 TSA workers unpaid for weeks. Goldman estimates a $14\u201318/bbl geopolitical risk premium in crude with an \u201coil cliff\u201d coming mid-April if Hormuz stays shut.\n**Net read:** The session reinforced the regime \u2014 Energy leadership accelerating, tech/growth under sustained pressure, Industrials (power/electrification cluster) holding relatively better. The screener\u2019s confirmed leaders in VRT, FIX, MTZ, GEV all held trend pass through the drawdown. Watch whether the April 6 Iran deadline produces resolution or further escalation."
  },
  "TOPIX": {
    ...
    daily: "**28 Mar session: Nikkei -0.43% to 53,373, TOPIX +0.19% to 3,650.** Mixed session as Japan digested the overnight US selloff. TOPIX outperformed Nikkei \u2014 value over growth. BOJ minutes revealed members discussing the need for accelerated rate hikes as oil-driven inflation pressures build. 30 Mar update: Nikkei crashed -3.97%, TOPIX -3.9% as Houthi missiles struck Israel (first direct involvement) and WTI surged past $102.\n**Tech/semi chain under renewed pressure.** Kioxia -4.2%, Advantest -3.9%, Tokyo Electron -3.1%, Disco -1.4% on Friday. This directly affects our screener\u2019s fading semi cluster \u2014 Advantest (#31 Fading CONFIRMED), DISCO (#23 Fading), IBIDEN (#21 Fading) all extended losses. Lasertec (#5 New Leader CONFIRMED) held up relatively better, consistent with its leadership status.\n**Cable infrastructure and trading houses resilient.** Fujikura (#1), Furukawa Electric (#2), and Sumitomo Electric (#7) \u2014 the core electrification cluster \u2014 held ground as physical infrastructure demand remains insulated from the geopolitical selloff. Trading houses (Mitsubishi Corp #4, Mitsui & Co #6) benefited from commodity exposure with INPEX surging +5.3% as the energy play.\n**Honda forecast first annual loss in ~70 years** \u2014 plunging 6% and the biggest drag on Nikkei. The auto sector\u2019s pain is consistent with Consumer Discretionary\u2019s -2.4% 1M RS in our screener. Panasonic (#9 New Leader) was a notable exception, bucking the auto-adjacent weakness.\n**Net read:** The Monday crash widened the gap between the screener\u2019s confirmed leaders (cable infra, trading houses, pharma) and the fading semi names. The Houthi escalation adds a new risk dimension \u2014 Japan imports 93% of its oil, and BOJ hawkishness on oil-driven inflation creates a domestic headwind. TOPIX\u2019s value tilt is performing."
  },
  "KOSPI": {
    ...
    daily: "**28 Mar session: KOSPI fell ~3% to 5,460, extending losses. 30 Mar: KOSPI crashed -5% to ~5,195** as Houthi missiles fired at Israel marked a dramatic escalation in the Middle East war. The index has now fallen -16.8% over 1 month within a +103.1% 1Y rally \u2014 the sharpest pullback in any market we cover.\n**Defence/infrastructure held up.** LS Electric (#1 New Leader) and Hanwha Systems (#2 New Leader) showed relative resilience, consistent with their +14.8% and +19.9% 1M RS. Korea Aerospace (#7), Hanwha Aerospace (#17, +100 acceleration \u2014 highest in KOSPI), and the broader defence cluster benefited from the escalation thesis. Korean defence stocks surged on the Houthi news.\n**Semiconductors remain under pressure.** SK Hynix and Samsung Electronics continued to fall. SK Hynix (#16) is mid-pack in the screener with +86.3 acceleration but not yet a leader \u2014 it\u2019s the key name to watch for a potential reversal. Hanmi Semiconductor (#8 Fading Leader) extended losses. Korea\u2019s 68% crude import dependence on Hormuz transit adds a macro headwind on top of sector-specific weakness.\n**Financial brokerages stable.** Mirae Asset Securities (#3, +63.8% EPS CONFIRMED) avoided the worst of the selloff, supported by elevated trading volumes from market volatility. Shinhan and KB Financial (both Accelerating) are the developing rotation theme.\n**Net read:** The session confirmed the screener\u2019s signal structure: defence/infrastructure outperforming, semis fading, financials emerging. KOSPI\u2019s extreme -16.8% 1M pullback within a +103% 1Y rally creates the widest short-term vs long-term divergence of any market. Only 6 confirmed names \u2014 very narrow. Position sizing should be minimal until the pullback stabilises."
  },
  "HSI": {
    ...
    daily: "**28 Mar session: Hang Seng +0.38% to 24,952, CSI 300 +0.56%.** A modest positive session as China was relatively insulated from the global risk-off. China industrial profits surged +15.2% YoY in Jan-Feb, providing a domestic macro tailwind. Two Chinese vessels were turned back from the Strait of Hormuz, however, signalling that even China\u2019s allied status with Iran isn\u2019t guaranteeing transit.\n**Energy continued to lead.** PetroChina (#4) and CNOOC (#7) \u2014 both Existing Leaders CONFIRMED \u2014 rallied further as Brent surged. The energy sector\u2019s +13.6% 1M RS and 75% trend pass remains the strongest thematic in Hong Kong.\n**WH Group held its #1 position.** The consumer staples leader (+9.5% 1M RS, CONFIRMED) benefited from defensive positioning. China Hongqiao (#2, +13.9% EPS CONFIRMED) also held \u2014 aluminium demand remains robust.\n**Financials developing.** AIA (#3 New Leader) and ICBC (#6 New Leader) are the freshest promotions. CCB (#11) shows +81.1 acceleration \u2014 the strongest early signal in HSI financials. State banks are grinding higher with positive RS and trend pass.\n**Tech/internet still absent.** Tencent, Alibaba, Meituan, Xiaomi \u2014 the entire complex remains bottom-half. JD.com\u2019s +98.6 acceleration at #40 (Emerging) is the strongest early signal from China tech but far from confirmation.\n**Net read:** Hong Kong\u2019s relative resilience reflects China\u2019s partial insulation from the Hormuz crisis (some Chinese vessels getting through) and the domestic industrial profit recovery. But the Houthi escalation over the weekend introduces new risk. Capital allocation should still favour other markets with deeper confirmed leadership."
  },
  "CSI300": {
    ...
    daily: "**28 Mar session: CSI 300 +0.56% to 4,503.** China outperformed global markets as domestic macro data surprised positively \u2014 industrial profits +15.2% YoY in Jan-Feb. The yuan-toll arrangement at Hormuz gives Chinese vessels partial transit access, insulating energy imports relative to Japan and Korea.\n**Energy and shipping strong.** COSCO Shipping (#6 CONFIRMED, +13.9% EPS) and Zhongyuan Oilfield (#7 CONFIRMED, +33.3% EPS) rallied. The energy sector\u2019s +16.3% 1M RS and 89% trend pass is the deepest energy confirmation of any market we cover.\n**Electrical infrastructure held.** Sieyuan Electric (#3 CONFIRMED), Dongfang Electric (#2), and the electrification cluster were stable despite broader volatility. Physical infrastructure demand is decoupled from the geopolitical risk narrative \u2014 consistent with the global pattern (US power/electrification and Japan cable infra also holding).\n**Financials rotation developing.** 11 Sector Rotation signals from state banks and brokerages. CNPC Capital (New Leader, +22.3% 1M RS) and Bank of Hangzhou (New Leader) are the freshest confirmations. ICBC (Emerging, +11.8% 1M RS) is in the earliest stages. This mirrors the developing financial rotation in the US (Comm Services inflecting) and Korea (Shinhan/KB accelerating).\n**Specialty materials leading.** Qinghai Salt Lake (#1, +15.7% EPS CONFIRMED) remains the top-ranked name. Ganfeng Lithium (#11, +24.7% EPS CONFIRMED) anchors the lithium recovery. The materials cluster has 8 confirmed names \u2014 the deepest sector confirmation in CSI 300.\n**Net read:** CSI 300\u2019s relative resilience is notable \u2014 only -5.3% 1M vs KOSPI\u2019s -16.8%. China\u2019s partial diplomatic channel with Iran (yuan-toll vessel exceptions) is a unique factor. The session confirmed the screener\u2019s leadership axis: energy/electrical infrastructure/materials. The Houthi escalation over the weekend introduces risk for Monday but China\u2019s insulation should continue to be a relative buffer."
  }
};
...
function renderCommentary() {
  ...
  el.innerHTML = `
    ${cmt.daily ? '<div class="p-3 bg-amber-50 rounded-lg border border-amber-200"><div class="text-xs uppercase tracking-wide text-amber-600 font-semibold mb-1">Price Action — 27-30 Mar</div><div class="text-sm text-amber-900 leading-relaxed">' + boldTextHtml(cmt.daily) + '</div></div>' : ''}
